...
const defaultState = [
  { name:'Monday', date:'June 23', primaryColor:'gray', blocks:[
  ...
  { name:'Tuesday', date:'June 24', primaryColor:'pink', blocks:[
  ...
  { name:'Wednesday', date:'June 25', primaryColor:'purple', blocks:[
  ...
  { name:'Thursday', date:'June 26', primaryColor:'pink', blocks:[
  ...
  { name:'Friday', date:'June 27', primaryColor:'blue', blocks:[
  ...
  { name:'Saturday', date:'June 28', primaryColor:'pink', blocks:[
  ...
  { name:'Sunday', date:'June 29', primaryColor:'rest', blocks:[
...
export default function Page() {
  ...
  async function loadPlan(showStatus = false) {
    try {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      if (!isSaving && !editing) loadPlan(false);
    }, 4000);
  ...
  async function resetPlan() {
    if (!confirm('Reset this planner back to the original version for everyone?')) return;
    await savePlan(copyPlan(defaultState));
  }
  ...
  return (
    <>
      <div className="wrap">
        <header>
          <h1>Week of June 23–29 💌</h1>
          <p>Tap a day to see what&apos;s going on</p>
          <div className="status">{status}</div>
          <button className="reset-btn" onClick={resetPlan}>Reset shared plan</button>
        </header>
